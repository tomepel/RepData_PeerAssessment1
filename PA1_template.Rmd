...
the result in a variable `sumstep` for future analysis. Note that we exclude
the days where there are only NA values from our analysis
...
the median now equal one of these values, hence the mean.
